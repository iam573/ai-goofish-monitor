...
const WEBHOOK_TEMPLATE_VARIABLES = '{{title}}, {{notification_title}}, {{keyword}}, {{content}}, {{price}}, {{reason}}, {{desktop_link}}, {{mobile_link}}, {{image_url}}, {{image_urls}}, {{image_gallery}}, {{image_carousel}}, {{xianyu_card}}'
