const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      excludeKeywordRules: 'Ignore Keywords',
      excludeKeywordRulesHint: 'If any ignore keyword matches, the item is immediately marked as not recommended. One keyword per line or comma-separated; alphanumeric keywords match whole words.',
      excludeKeywordRulesPlaceholder: 'Example: repaired\nrefurbished\ndisplay only',
    ...
    table: {
      ...
      excludeKeywordStrategies: '{count} ignore terms',
  ...
  notifyPanel: {
    ...
    supportedVariables: 'Supported variables: title=full item title / notification_title=short title / keyword / content / price / reason / desktop_link / mobile_link / image_url=item image / image_urls=image list / image_gallery=image gallery HTML / image_carousel=large swipe gallery HTML / xianyu_card=Xianyu-style HTML card',
    ...
    secretPlaceholder: 'Enter configuration value',
    secretKeepPlaceholder: 'Enter token',
    notConfigured: 'Not configured yet.',
    ntfy: {
      description: 'Best for lightweight delivery. The topic URL is not sensitive and can be displayed directly.',
    },
    bark: {
      description: 'The URL contains a device key and is shown on this admin page.',
      configuredHint: 'Current URL is loaded and can be edited directly.',
    },
    gotify: {
    ...
    wecom: {
      title: 'WeCom Bot',
      description: 'The bot URL contains a key and is shown on this admin page for direct editing or clearing.',
      urlLabel: 'WeCom Bot URL',
      configuredHint: 'Current bot URL is loaded.',
    },
    telegram: {
      description: 'The bot token is loaded in a password field. Chat ID and API base URL can be viewed and updated directly.',
      chatIdPlaceholder: 'Example: 123456789',
      apiBaseUrl: 'API / Proxy Base URL',
    },
    webhook: {
      title: 'Generic Webhook',
      description: 'Supports JSON template variables. URL, headers, and body are shown directly for easier configuration checks.',
